...
# InterMPL (SC-CTC)
# $ ./run_intermpl.sh --train_config conf/tuning/train_cfm_scctc_intermpl.yaml --decode_config conf/tuning/decode_interctc.yaml --nbpe 1024 --units unigram1024,unigram1024,unigram1024 --unlab_set train_clean_360
# InterMPL-Last (SC-CTC)
# $ ./run_intermpl.sh --train_config conf/tuning/train_cfm_scctc_intermpl_last.yaml --decode_config conf/tuning/decode_interctc.yaml --nbpe 1024 --units unigram1024,unigram1024,unigram1024 --unlab_set train_clean_360
# InterMPL (HC-CTC)
# $ ./run_intermpl.sh --train_config conf/tuning/train_cfm_hcctc_intermpl.yaml --decode_config conf/tuning/decode_interctc.yaml --nbpe 4096 --units unigram256,unigram1024,unigram4096 --unlab_set train_clean_360
...
expname=${train_set}+${unlab_set}_${units}_$(basename ${train_config%.*})
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    unlab_json=${feat_ul_dir}/data_${units}_${train_set}.json
