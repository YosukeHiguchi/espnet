...
from espnet2.hubert.bestrq_espnet_model import ESPnetSSLModel
...
class SSLTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            default=get_default_kwargs(ESPnetSSLModel),
    ...
    @classmethod
    def build_model(cls, args: argparse.Namespace) -> ESPnetSSLModel:
        assert check_argument_types()
